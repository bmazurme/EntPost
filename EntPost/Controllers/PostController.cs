...
namespace EntPost.Controllers
{
    public class PostController : Controller
    {
        ...
        //public async Task<IActionResult> Note([Bind("Id,Title,Body,ReleaseDate")] Note note)
        //{
        ...
        [HttpPost]
        public string Note(string data)
        {
